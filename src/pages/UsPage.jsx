                ...
                <div className=' pt-[8rem] flex-flex-col items-center justify-center'>
                    ...
                    <div className='w-full flex flex-col items-center gap-[2rem]'>
                        ...
                        <div className='w-full flex flex-col items-center '>
                            <div className='flex flex-wrap gap-y-4 md:gap-y-0 md:gap-8 items-center justify-center'>
                                <div className='gap-2 w-[40%] md:w-auto flex flex-col items-center justify-center'>
